...
#from training.bayesian_UNet import *
...
from training.Probabilistic_UNet import *
from training.Generic_UNet import *
from training.Hierarchical_Prob_UNet import *
from training.Bayesian_UNet import *
...
#        if self.architecture_name in ["Generic_UNet","Probabilistic_UNet","HierarchicalProbUNet"]:
...
#        elif self.architecture_name == "Bayesian_UNet":
#            m = importlib.import_module('training.bayesian_UNet')
#            architecture_class = getattr(m, self.architecture_name)
#            print(architecture_class)


        if self.architecture_name == "Generic_UNet": 
        ...
        elif self.architecture_name == "Probabilistic_UNet":
            self.network = Probabilistic_UNet(self.num_input_channels, self.base_num_features, self.num_classes,
                                              len(self.net_num_pool_op_kernel_sizes),
                                              self.conv_per_stage, 2, conv_op, norm_op, norm_op_kwargs, dropout_op,
                                              dropout_op_kwargs,
                                              net_nonlin, net_nonlin_kwargs, True, False, lambda x: x, InitWeights_He(1e-2),
                                              self.net_num_pool_op_kernel_sizes, self.net_conv_kernel_sizes, False, True, True)
        elif self.architecture_name == "Hierarchical_Prob_UNet":
            self.network = Hierarchical_Prob_UNet(self.num_input_channels, self.base_num_features, self.num_classes,
                                              len(self.net_num_pool_op_kernel_sizes),
                                              self.conv_per_stage, 2, conv_op, norm_op, norm_op_kwargs, dropout_op,
                                              dropout_op_kwargs,
                                              net_nonlin, net_nonlin_kwargs, True, False, lambda x: x, InitWeights_He(1e-2),
            ...
            self.network = Bayesian_UNet(self.num_input_channels, self.base_num_features, self.num_classes,
                                              len(self.net_num_pool_op_kernel_sizes),
                                              self.conv_per_stage, 2, conv_op, norm_op, norm_op_kwargs, dropout_op,
                                              dropout_op_kwargs,
                                              net_nonlin, net_nonlin_kwargs, True, False, lambda x: x, InitWeights_He(1e-2),
