...
class SegmentationNetwork(NeuralNetwork):
    ...
    def predict_3D(self, x: np.ndarray, do_mirroring: bool, mirror_axes: Tuple[int, ...] = (0, 1, 2),
        ...
        with context():
            with torch.no_grad():
                if self.conv_op == nn.Conv3d  or self.conv_op == Conv3dReparameterization or self.conv_op == Conv3dFlipout:
                ...
                elif self.conv_op == nn.Conv2d or self.conv_op == Conv2dReparameterization or self.conv_op == Conv2dFlipout :
                    if use_sliding_window:
