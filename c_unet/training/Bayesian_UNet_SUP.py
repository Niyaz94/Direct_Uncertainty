...
class Bayesian_UNet(SegmentationNetwork):
    ...
    def __init__(
        ...
        ### MEEEEEE ###
        self.conv_op    = choosen_layer(self.conv_op)
        self.transpconv = choosen_layer(transpconv)
        ...
        self.conv_blocks_context.append(nn.Sequential(
            ...
            StackedConvLayers(
                output_features, final_num_features, 1, self.conv_op, self.conv_kwargs,self.norm_op, self.norm_op_kwargs, 
        ...
        for u in range(num_pool):
            ...
            if not self.convolutional_upsampling:
                ...
                self.transpconv = choosen_layer(self.transpconv)
