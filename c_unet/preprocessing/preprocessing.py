...
from c_unet.preprocessing.main import RESAMPLING_SEPARATE_Z_ANISO_THRESHOLD
from c_unet.preprocessing.crop import get_case_identifier_from_npz, ImageCropper
from skimage.transform import resize
from scipy.ndimage.interpolation import map_coordinates
import numpy as np
from batchgenerators.utilities.file_and_folder_operations import subfiles, maybe_mkdir_p, load_pickle, join
from multiprocessing.pool import Pool

# MS Dropped(left commented): Preprocessor3DDifferentResampling, Preprocessor3DBetterResampling,
# PreprocessorFor3D_NoResampling, PreprocessorFor2D_noNormalization
...
class GenericPreprocessor(object):
    ...
    def run(self, target_spacings, input_folder_with_cropped_npz, output_folder, data_identifier,
            num_threads, force_separate_z=None):
        """
